...
export default function Loginform1() {
  ...
  return (
    <>
      <section className=" object-cover lg:bg-transparent  bg-[#202020] bg-cover bg-no-repeat items-start justify-center relative 2xl:h-screen xl:h-[721px] lg:h-[700px] md:h-[650px] h-auto  ">
          <img src="../assets/images/Signin.png" className="w-full lg:block hidden absolute !-z-10 top-0 left-0 right-0 bottom-0 h-full" />
            ...
            <div className="flex items-center md:flex-nowrap flex-wrap p-12 justify-between rounded-[5px]-2xl lg:w-[80%] overflow-hidden mx-auto">
              ...
              <div 
                ...
                <img
                  ...
                  className="w-full inline-block lg:hidden h-full"
                  alt="Sample image" />
              </div>
              <div className="xl:w-[38%] md:w-1/2 w-full">
                <div className="flex items-centerlg:mb-20 md:mb-10 mb-5 justify-center">
                  <img src="../assets/images/formlogo.svg" className="w-20 mx-auto" />
                </div>
                  ...
                  >
                    ...
                    <div className="lg:mb-4 md:mb-3 mb-2">
                      ...
                      <div className="relative flex items-center ">
                        ...
                        >
                          <img className="w-6 mx-auto" src={showPassword ? "../assets/eye.svg" : "../assets/images/eye-slash.svg"} /> </button></div>
